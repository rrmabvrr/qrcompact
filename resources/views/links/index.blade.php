                ...
                <div class="card-body p-4 p-lg-5">
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-start gap-3 mb-4">
                        <div>
                            ...
                            <p class="text-body-secondary mb-0">Informe uma URL completa iniciando com http:// ou https://.</p>
                        </div>
                    </div>

                    <form class="row g-3" data-links-form>
                        <div class="col-12">
                    ...
                    <section class="result-panel mt-4" data-links-result hidden>
                        <div>
                ...
                <div class="card-body p-4 p-lg-5">
                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-start gap-3 mb-4">
                        <div>
                            ...
                            <p class="text-body-secondary mb-0">Do mais recente para o mais antigo, com consulta de QR e edicao por slug.</p>
                        </div>
                    </div>
